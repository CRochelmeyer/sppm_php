...
if (mysqli_num_rows($query) > 0) {
    $succes = "<fieldset><legend>Displaying sales report between $rdatefrom and $rdateto, refined by type</legend><div class=\"container-fluid\"><table class=\"table\" border=\"1\">
    ...
    $succes .= "<a class=\"btn\" href=\"export1.php\"><input type=\"button\" value=\"Download as CSV\" /></a></table></div></fieldset>";
} else {
